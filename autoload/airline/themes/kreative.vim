...
function! airline#themes#kat#refresh()
	...
	" lua require('kreative.highlights.integrations.airline').init()
	let g:airline#themes#kat#palette = {}
  let M0 = airline#themes#get_highlight('Identifier')
  let accents_group = airline#themes#get_highlight('Special')
  let modified_group = [M0[1], '', M0[2], '', '']
  let modified_group_norm = luaeval('require("kreative.highlights.integrations.airline").modifiedC("normal")')
  let modified_group_inactive = luaeval('require("kreative.highlights.integrations.airline").modifiedC("inactive")')
  let warning_group = luaeval('require("kreative.highlights.integrations.airline").warningGroup()')
  let error_group = luaeval('require("kreative.highlights.integrations.airline").errorGroup()')

  let s:N1 = luaeval('require("kreative.highlights.integrations.airline").normalMode_a()')
  let s:N2 = luaeval('require("kreative.highlights.integrations.airline").normalMode_b()')
  let s:N3 = luaeval('require("kreative.highlights.integrations.airline").normalMode_c()')
  ...
  let s:I1 = luaeval('require("kreative.highlights.integrations.airline").insertMode_a()')
  let s:I2 = luaeval('require("kreative.highlights.integrations.airline").insertMode_b()')
  let s:I3 = luaeval('require("kreative.highlights.integrations.airline").insertMode_c()')
  ...
  let s:R1 = luaeval('require("kreative.highlights.integrations.airline").replaceMode_a()')
  let s:R2 = luaeval('require("kreative.highlights.integrations.airline").replaceMode_b()')
  let s:R3 = luaeval('require("kreative.highlights.integrations.airline").replaceMode_c()')
  ...
  let s:V1 = luaeval('require("kreative.highlights.integrations.airline").visualMode_a()')
  let s:V2 = luaeval('require("kreative.highlights.integrations.airline").visualMode_b()')
  let s:V3 = luaeval('require("kreative.highlights.integrations.airline").visualMode_c()')
  ...
  let s:IA = luaeval('require("kreative.highlights.integrations.airline").inactiveGroup()')
  ...
  let s:T1 = luaeval('require("kreative.highlights.integrations.airline").terminalMode_a()')
  let s:T2 = luaeval('require("kreative.highlights.integrations.airline").terminalMode_b()')
  let s:T3 = luaeval('require("kreative.highlights.integrations.airline").terminalMode_c()')
