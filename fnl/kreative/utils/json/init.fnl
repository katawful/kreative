(module kreative.utils.json.init
...
(defonce path (.. std-data :/kreative/json/))
...
Searches from 'kreative.highlights'
@suffix -- based on the module structure of this plugin
           with 'kreative.highlights' removed from the module name"
      (let [file (string.format "kreative.highlights.%s" suffix)]
