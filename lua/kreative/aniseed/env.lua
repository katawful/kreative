...
local _2amodule_name_2a = "kreative.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("kreative.aniseed.compile"), autoload("kreative.aniseed.fennel"), autoload("kreative.aniseed.fs"), autoload("kreative.aniseed.nvim")
