...
local _2amodule_name_2a = "kreative.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("kreative.aniseed.core"), autoload("kreative.aniseed.compile"), autoload("kreative.aniseed.fennel"), autoload("kreative.aniseed.fs"), autoload("kreative.aniseed.nvim")
