...
local _2amodule_name_2a = "kreative.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("kreative.aniseed.core"), autoload("kreative.aniseed.fs"), autoload("kreative.aniseed.nvim"), autoload("kreative.aniseed.string")
...
local function impl()
  local compiler = require("kreative.aniseed.deps.fennel")
