...
local _2amodule_name_2a = "kreative.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("kreative.aniseed.core"), autoload("kreative.aniseed.env"), autoload("kreative.aniseed.eval"), autoload("kreative.aniseed.nvim")
