...
local function init()
  ...
  if (main.configs.background == "light") then
    vim.g["terminal_color_11"] = ucolors.darken(colors.kreative.orange.base.color, 0.2)
    ...
    do end (vim.g)["terminal_color_9"] = ucolors.darken(colors.kreative.red.base.color, 0.2)
    do end (vim.g)["terminal_color_10"] = ucolors.darken(colors.kreative.green.base.color, 0.2)
    return {nil, nil, nil, nil, nil, nil}
  else
    vim.g["terminal_color_11"] = ucolors.brighten(colors.kreative.orange.base.color, 0.2)
    ...
    do end (vim.g)["terminal_color_9"] = ucolors.brighten(colors.kreative.red.base.color, 0.2)
