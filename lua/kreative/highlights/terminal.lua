...
local function init()
  ...
  if (main.configs.background == "light") then
    vim.g["terminal_color_12"] = ucolors.darken(colors.kreative.blue.base.color, 0.2)
    ...
    vim.g["terminal_color_12"] = ucolors.brighten(colors.kreative.blue.base.color, 0.2)
