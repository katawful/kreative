local _2afile_2a = "fnl/kreative/utils/highlight/get.fnl"
local _2amodule_name_2a = "kreative.utils.highlight.get"
local _2amodule_2a
do
...
local a, s = autoload("kreative.aniseed.core"), autoload("kreative.aniseed.string")
