local _2afile_2a = "fnl/kreative/utils/message/init.fnl"
local _2amodule_name_2a = "kreative.utils.message.init"
local _2amodule_2a
do
...
local function _3c_table(from_module, message_type)
  ...
  local output = string.format("Kreative %s%s: %s", notify_type, message_table.number, message_table.message)
  return output
end
